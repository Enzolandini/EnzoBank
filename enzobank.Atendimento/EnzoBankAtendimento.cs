...
using enzobank_ATENDIMENTO.enzobank.Exceptions;

namespace enzobank_ATENDIMENTO.enzobank.Atendimento
{
    #nullable disable
    internal  class EnzoBankAtendimento
    {
        ...
        public void AtendimentoCliente()
        {
            try
            {
                ...
                while (opcao != '6')
                {
                    ...
                    {
                        throw new EnzoBankException(excecao.Message);
                    }
            ...
            catch (EnzoBankException excecao)
            {
